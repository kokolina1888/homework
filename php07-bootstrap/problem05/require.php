<?php 
	...
	$sites[0] = array('name' => 'IMBD',
		...
		'logo' => '<img src="css/imbd.jpg">');
	$sites[1] = array(	'name' => 'Amazon',
		'short info' => ' It is the largest Internet-based retailer in the United States.',
		'creator' => 'Jeff Bezos',
		'users' => '270 mln/year',
		'technology' => 'unknown',
		'logo' => '<img src="css/amazon.jpg">');
	$sites[2] = array(	'name' => 'Ok',
	...
	$sites[3] = array(	'name' => 'GitHub', 
		...
		'logo' => '<img src="css/github.jpg">');
	$sites[4] = array(	'name' => 'Kat',
